...
namespace GameEntities.Items {
    ...
    public class ItemsFactory : IFactoryProducer<IItem, ItemProfile> {
        ...
        private Dictionary<ItemType, IItemInfo> infos = new Dictionary<ItemType, IItemInfo> {
            ...
            { ItemType.Crossbow, new ItemWeaponInfo(ItemType.Crossbow, ItemWieldType.OneHand, SkillType.RangeWeapon, 5, 3, "Crossbow")},
            { ItemType.Morningstar, new ItemWeaponInfo(ItemType.Morningstar, ItemWieldType.OneHand, SkillType.BluntWeapon, 5, 8, "Morning Star")},
            { ItemType.Scythe, new ItemWeaponInfo(ItemType.Scythe, ItemWieldType.OneHand, SkillType.HeavyBlade, 5, 10, "Scythe")},
            { ItemType.Club, new ItemWeaponInfo(ItemType.Club, ItemWieldType.OneHand, SkillType.BluntWeapon, 5,6, "Club")},
            { ItemType.Sling, new ItemWeaponInfo(ItemType.Sling, ItemWieldType.OneHand, SkillType.RangeWeapon, 5,3, "Sling")},
            { ItemType.Mace, new ItemWeaponInfo(ItemType.Mace, ItemWieldType.OneHand, SkillType.BluntWeapon, 5,8, "Mace")},
            { ItemType.Sicle, new ItemWeaponInfo(ItemType.Sicle, ItemWieldType.OneHand, SkillType.LightBlade, 5,6, "Sicle")},
            { ItemType.Spear, new ItemWeaponInfo(ItemType.Spear, ItemWieldType.OneHand, SkillType.PolearmWeapon, 5,8, "Spear")},
            { ItemType.Halberd, new ItemWeaponInfo(ItemType.Halberd, ItemWieldType.OneHand, SkillType.PolearmWeapon, 5,3, "Halberd")},
            { ItemType.LongBow, new ItemWeaponInfo(ItemType.LongBow, ItemWieldType.OneHand, SkillType.RangeWeapon, 5,3, "Long Bow")},
            { ItemType.HandAxe, new ItemWeaponInfo(ItemType.HandAxe, ItemWieldType.OneHand, SkillType.AxeWeapon, 5,3, "Hand Axe")},
            { ItemType.ShortBow, new ItemWeaponInfo(ItemType.ShortBow, ItemWieldType.OneHand, SkillType.RangeWeapon, 5,3, "Short Bow")},
            { ItemType.Maul, new ItemWeaponInfo(ItemType.Maul, ItemWieldType.OneHand, SkillType.BluntWeapon, 5,3, "Maul")},
            { ItemType.GreatAxe, new ItemWeaponInfo(ItemType.GreatAxe, ItemWieldType.OneHand, SkillType.AxeWeapon, 5,3, "Great Axe")},
            { ItemType.WarPick, new ItemWeaponInfo(ItemType.WarPick, ItemWieldType.OneHand, SkillType.AxeWeapon, 5,3, "War Pick")},
            { ItemType.BastardSword, new ItemWeaponInfo(ItemType.BastardSword, ItemWieldType.OneHand, SkillType.HeavyBlade, 5,3, "Bastard Sword")},
            { ItemType.Warhammer, new ItemWeaponInfo(ItemType.Warhammer, ItemWieldType.OneHand, SkillType.HammerWeapon, 5,3, "Warhammer")},
            { ItemType.Flail, new ItemWeaponInfo(ItemType.Flail, ItemWieldType.OneHand, SkillType.FlailWeapon, 5,3, "Flail")},
            { ItemType.BattleAxe, new ItemWeaponInfo(ItemType.BattleAxe, ItemWieldType.OneHand, SkillType.AxeWeapon, 5,3, "Battle Axe")},
            { ItemType.ThrowingHammer, new ItemWeaponInfo(ItemType.ThrowingHammer, ItemWieldType.OneHand, SkillType.RangeWeapon, 5,3, "Throwing Hammer")},
            { ItemType.Scimitar, new ItemWeaponInfo(ItemType.Scimitar, ItemWieldType.OneHand, SkillType.BluntWeapon, 5,3, "Scimitar")},
            { ItemType.Glaive, new ItemWeaponInfo(ItemType.Glaive, ItemWieldType.OneHand, SkillType.PolearmWeapon, 5,3, "Glaive")},
            { ItemType.ShortSword, new ItemWeaponInfo(ItemType.ShortSword, ItemWieldType.OneHand, SkillType.LightBlade, 5,3, "Short Sword")},
            { ItemType.SpellBook, new ItemWeaponInfo(ItemType.SpellBook, ItemWieldType.OneHand, SkillType.UniversalMagic, 5, 3, "Spell Book")},
            { ItemType.StrawHat, new ItemArmorInfo(ItemType.StrawHat, InventorySlot.Head, 5, 1, "Straw Hat")},
            { ItemType.ClothCap, new ItemArmorInfo(ItemType.ClothCap, InventorySlot.Head, 5, 1, "Cloth Cap")},
            { ItemType.ClothVest, new ItemArmorInfo(ItemType.ClothVest, InventorySlot.Chest, 5, 1, "Cloth Vest")},
            { ItemType.ClothShoes, new ItemArmorInfo(ItemType.ClothShoes, InventorySlot.Feet, 5, 1, "Cloth Shoes")},
            { ItemType.ClothShirt, new ItemArmorInfo(ItemType.ClothShirt, InventorySlot.Chest, 5, 1, "Cloth Shirt")},
            { ItemType.ClothLeggings, new ItemArmorInfo(ItemType.ClothLeggings, InventorySlot.Legs, 5, 1, "Cloth Leggings")},
            { ItemType.ClothGloves, new ItemArmorInfo(ItemType.ClothGloves, InventorySlot.Hands, 5, 1, "Cloth Gloves")},
            { ItemType.FishingPole, new ItemToolInfo(ItemType.FishingPole, ItemWieldType.OneHand, SkillType.Fishing, 5, "Fishing Pole") },
            { ItemType.FishingNet, new ItemToolInfo(ItemType.FishingNet, ItemWieldType.BothHands, SkillType.Fishing, 5, "Fishing Net") },
            { ItemType.CrabTrap, new ItemToolInfo(ItemType.CrabTrap, ItemWieldType.OneHand, SkillType.Fishing, 5, "Crab Trap") },
            { ItemType.Insect, new ItemConsumableInfo(ItemClassCode.Bait | ItemClassCode.Food, ItemType.Insect, 5, "Insect/Bait") },
            { ItemType.Minnow, new ItemConsumableInfo(ItemClassCode.Bait | ItemClassCode.Food, ItemType.Minnow, 5, "Minnow/Bait") },
            { ItemType.Worm, new ItemConsumableInfo(ItemClassCode.Bait | ItemClassCode.Food, ItemType.Worm, 5, "Worm/Bait") },
            { ItemType.Clam, new ItemConsumableInfo(ItemClassCode.Bait | ItemClassCode.Food, ItemType.Clam, 5, "Clam/Bait") },
            { ItemType.DoughBall, new ItemConsumableInfo(ItemClassCode.Bait | ItemClassCode.Food, ItemType.DoughBall, 5, "Dough Ball/Bait") },
            { ItemType.FishingHook, new ItemConsumableInfo(ItemClassCode.Bait | ItemClassCode.Food, ItemType.FishingHook, 5, "Fish Hook") },
        };
