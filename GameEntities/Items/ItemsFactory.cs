...
namespace GameEntities.Items {
    ...
    public class ItemsFactory : IFactoryProducer<IItem, ItemProfile> {
        ...
        private Dictionary<ItemType, IItemInfo> infos = new Dictionary<ItemType, IItemInfo> {
            { ItemType.LongSword, new ItemWeaponInfo(ItemType.LongSword, ItemEquipType.LeftHand, SkillType.HeavyBlade, 3, "Long Sword") },
            { ItemType.QuarterStaff, new ItemWeaponInfo(ItemType.QuarterStaff, ItemEquipType.LeftHand, SkillType.StaffWeapon, 4, "Quarter Staff") },
            { ItemType.LongStaff, new ItemWeaponInfo(ItemType.LongStaff, ItemEquipType.LeftHand, SkillType.StaffWeapon, 4, "Long Staff") },
           
          
            { ItemType.Javelin, new ItemWeaponInfo(ItemType.Javelin, ItemEquipType.LeftHand, SkillType.RangeWeapon, 6, "Javelin") },
            { ItemType.GreatClub, new ItemWeaponInfo(ItemType.GreatClub, ItemEquipType.LeftHand, SkillType.BluntWeapon, 10, "Great Club") },
            { ItemType.Dagger, new ItemWeaponInfo(ItemType.Dagger, ItemEquipType.LeftHand, SkillType.LightBlade,4, "Dagger")},
            { ItemType.Crossbow, new ItemWeaponInfo(ItemType.Crossbow, ItemEquipType.LeftHand, SkillType.RangeWeapon,3, "Crossbow")},
            { ItemType.Morningstar, new ItemWeaponInfo(ItemType.Morningstar, ItemEquipType.LeftHand, SkillType.BluntWeapon,8, "Morning Star")},
            { ItemType.Scythe, new ItemWeaponInfo(ItemType.Scythe, ItemEquipType.LeftHand, SkillType.HeavyBlade,10, "Scythe")},
            { ItemType.Club, new ItemWeaponInfo(ItemType.Club, ItemEquipType.LeftHand, SkillType.BluntWeapon,6, "Club")},
            { ItemType.Sling, new ItemWeaponInfo(ItemType.Sling, ItemEquipType.LeftHand, SkillType.RangeWeapon,3, "Sling")},
            { ItemType.Mace, new ItemWeaponInfo(ItemType.Mace, ItemEquipType.LeftHand, SkillType.BluntWeapon,8, "Mace")},
            { ItemType.Sicle, new ItemWeaponInfo(ItemType.Sicle, ItemEquipType.LeftHand, SkillType.LightBlade,6, "Sicle")},
            { ItemType.Spear, new ItemWeaponInfo(ItemType.Spear, ItemEquipType.LeftHand, SkillType.PolearmWeapon,8, "Spear")},
            { ItemType.Halberd, new ItemWeaponInfo(ItemType.Halberd, ItemEquipType.LeftHand, SkillType.PolearmWeapon,3, "Halberd")},
            { ItemType.LongBow, new ItemWeaponInfo(ItemType.LongBow, ItemEquipType.LeftHand, SkillType.RangeWeapon,3, "Long Bow")},
            { ItemType.HandAxe, new ItemWeaponInfo(ItemType.HandAxe, ItemEquipType.LeftHand, SkillType.AxeWeapon,3, "Hand Axe")},
            { ItemType.ShortBow, new ItemWeaponInfo(ItemType.ShortBow, ItemEquipType.LeftHand, SkillType.RangeWeapon,3, "Short Bow")},
            { ItemType.Maul, new ItemWeaponInfo(ItemType.Maul, ItemEquipType.LeftHand, SkillType.BluntWeapon,3, "Maul")},
            { ItemType.GreatAxe, new ItemWeaponInfo(ItemType.GreatAxe, ItemEquipType.LeftHand, SkillType.AxeWeapon,3, "Great Axe")},
            { ItemType.WarPick, new ItemWeaponInfo(ItemType.WarPick, ItemEquipType.LeftHand, SkillType.AxeWeapon,3, "War Pick")},
            { ItemType.BastardSword, new ItemWeaponInfo(ItemType.BastardSword, ItemEquipType.LeftHand, SkillType.HeavyBlade,3, "Bastard Sword")},
            { ItemType.Warhammer, new ItemWeaponInfo(ItemType.Warhammer, ItemEquipType.LeftHand, SkillType.HammerWeapon,3, "Warhammer")},
            { ItemType.Flail, new ItemWeaponInfo(ItemType.Flail, ItemEquipType.LeftHand, SkillType.FlailWeapon,3, "Flail")},
            { ItemType.BattleAxe, new ItemWeaponInfo(ItemType.BattleAxe, ItemEquipType.LeftHand, SkillType.AxeWeapon,3, "Battle Axe")},
            { ItemType.ThrowingHammer, new ItemWeaponInfo(ItemType.ThrowingHammer, ItemEquipType.LeftHand, SkillType.RangeWeapon,3, "Throwing Hammer")},
            { ItemType.Scimitar, new ItemWeaponInfo(ItemType.Scimitar, ItemEquipType.LeftHand, SkillType.BluntWeapon,3, "Scimitar")},
            { ItemType.Glaive, new ItemWeaponInfo(ItemType.Glaive, ItemEquipType.LeftHand, SkillType.PolearmWeapon,3, "Glaive")},
            { ItemType.ShortSword, new ItemWeaponInfo(ItemType.ShortSword, ItemEquipType.LeftHand, SkillType.LightBlade,3, "Short Sword")},
            { ItemType.SpellBook, new ItemWeaponInfo(ItemType.SpellBook, ItemEquipType.LeftHand, SkillType.UniversalMagic, 3, "Spell Book")},
            ...
            { ItemType.ClothGloves, new ItemArmorInfo(ItemType.ClothGloves, ItemEquipType.LeftHand, 1, "Cloth Gloves")},
            { ItemType.FishingPole, new ItemToolInfo(ItemType.FishingPole, ItemEquipType.LeftHand, SkillType.Fishing, "Fishing Pole") },
            { ItemType.FishingNet, new ItemToolInfo(ItemType.FishingNet, ItemEquipType.LeftHand, SkillType.Fishing, "Fishing Net") },
            { ItemType.CrabTrap, new ItemToolInfo(ItemType.CrabTrap, ItemEquipType.LeftHand, SkillType.Fishing, "Crab Trap") },
